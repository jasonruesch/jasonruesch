  ...
  return (
    <Popover {...props}>
      ...
      <PopoverPanel
        focus
        transition
        className="fixed inset-x-4 top-[calc(env(safe-area-inset-top)+(--spacing(8)))] z-50 origin-top rounded-3xl bg-white p-8 ring-1 ring-zinc-900/5 duration-150 data-closed:scale-95 data-closed:opacity-0 data-enter:ease-out data-leave:ease-in dark:bg-zinc-900 dark:ring-zinc-800"
      >
        {({ close }) => (
          <>
