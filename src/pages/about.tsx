...
import { Container, GitHubIcon, LinkedInIcon } from "../components";
...
function SocialLink({
  ...
  return (
    <li className={clsx(className, "flex")}>
      <Link
        to={href}
        className="group flex items-center text-sm font-medium text-neutral-800 transition hover:text-cyan-500 dark:text-neutral-200 dark:hover:text-violet-400"
      >
        <Icon className="h-6 w-6 flex-none fill-neutral-500 transition group-hover:fill-cyan-500 dark:group-hover:fill-violet-400" />
