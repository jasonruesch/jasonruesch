    ...
    >
      ...
      <div className="mt-6 flex">
        <input
          ...
          required
          className="min-w-0 flex-auto appearance-none rounded-md border border-neutral-900/10 bg-white px-3 py-[calc(--spacing(2)-1px)] shadow-md shadow-neutral-800/5 placeholder:text-neutral-400 focus:border-cyan-500 focus:ring-4 focus:ring-cyan-500/10 focus:outline-hidden sm:text-sm dark:border-neutral-700 dark:bg-neutral-700/[0.15] dark:text-neutral-200 dark:placeholder:text-neutral-500 dark:focus:border-violet-400 dark:focus:ring-violet-400/10"
        />
...
function Role({ role }: { role: Role }) {
  ...
  return (
    <li className="flex gap-4">
      <div className="relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full ring-1 shadow-md shadow-neutral-800/5 ring-neutral-900/5 dark:border dark:border-neutral-700/50 dark:bg-neutral-800 dark:ring-0">
      ...
      <div className="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8">
        {[image1, image2, image3, image4, image5].map((image, imageIndex) => (
          <div
            key={image}
            className={clsx(
              "relative aspect-9/10 w-44 flex-none overflow-hidden rounded-xl bg-neutral-100 sm:w-72 sm:rounded-2xl dark:bg-neutral-800",
...
export default function Home() {
  ...
  ]; // (await getAllArticles()).slice(0, 4);
