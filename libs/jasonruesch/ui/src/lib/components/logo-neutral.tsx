      ...
      <g transform="matrix(1.2613611714553135,0,0,1.2613611714553135,-8.234481943284555,-3.7538274755242695)">
        <g transform="translate(0,-957.3622)">
          ...
          >
            <stop
              offset="0"
              className="[stop-color:var(--color-neutral-300)] dark:[stop-color:var(--color-neutral-400)]"
            />
            <stop
              offset="1"
              className="[stop-color:var(--color-neutral-500)] dark:[stop-color:var(--color-neutral-600)]"
            />
          </linearGradient>
          <path
            fillRule="evenodd"
