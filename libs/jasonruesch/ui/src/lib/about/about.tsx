    ...
    <Page>
      <div className="flex flex-1 flex-col items-center justify-center gap-4">
        ...
        <div className="max-w-lg text-justify sm:max-w-screen-sm lg:max-w-screen-lg">
          ...
          />
          <p className="mb-4">
            I hold a Bachelor of Science in Computer Science and have dedicated
            my career to the dynamic world of web development. My focus is on
            crafting intuitive and visually stunning interfaces that elevate
            user experiences.
          </p>
          <p className="mb-4">
