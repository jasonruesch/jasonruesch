      ...
      <g transform="matrix(1.2613611714553135,0,0,1.2613611714553135,-8.234481943284555,-3.7538274755242695)">
        <g transform="translate(0,-957.3622)">
          ...
          >
            <stop
              offset="0"
              className="[stop-color:theme(colors.primary-500)] dark:[stop-color:theme(colors.primary-400)]"
            />
            <stop
              offset="1"
              className="[stop-color:theme(colors.secondary-500)] dark:[stop-color:theme(colors.secondary-400)]"
            />
          </linearGradient>
          <path
            fillRule="evenodd"
