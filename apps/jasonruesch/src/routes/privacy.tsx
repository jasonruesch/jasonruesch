...
export default function Privacy() {
  ...
  const setTargetRef = (target: string, ref: HTMLElement | null) => {
    if (!ref) return;

    targetRefs.current.set(target, ref);
    ...
    <Page contentClassName="flex flex-col items-start">
      ...
      <ul className="ml-4 list-disc pl-4">
        <li>
          ...
          <a
            className="text-primary-500 hover:text-primary-600 dark:text-primary-400 dark:hover:text-primary-500 font-medium"
      ...
      <div className="space-y-4">
        <section
          ...
          className="space-y-4"
          ref={(ref) => setTargetRef('summaryofkeypoints', ref)}
        >
        ...
        <section
          id="infocollect"
          className="space-y-4"
          ref={(ref) => setTargetRef('infocollect', ref)}
        >
          <h2 className="text-xl font-medium sm:text-3xl">
          ...
          <h3
            ...
            id="personalinfo"
            ref={(ref) => setTargetRef('personalinfo', ref)}
          >
          ...
          <h3
            id="sensitiveinfo"
            className="text-lg font-medium sm:text-2xl"
            ref={(ref) => setTargetRef('sensitiveinfo', ref)}
          >
        ...
        <section
          id="infouse"
          className="space-y-4"
          ref={(ref) => setTargetRef('infouse', ref)}
        >
          <h2 className="text-xl font-medium sm:text-3xl">
        ...
        <section
          id="whoshare"
          className="space-y-4"
          ref={(ref) => setTargetRef('whoshare', ref)}
        >
          <h2 className="text-xl font-medium sm:text-3xl">
        ...
        <section
          id="inforetain"
          className="space-y-4"
          ref={(ref) => setTargetRef('inforetain', ref)}
        >
          <h2 className="text-xl font-medium sm:text-3xl">
        ...
        <section
          id="infosafe"
          className="space-y-4"
          ref={(ref) => setTargetRef('infosafe', ref)}
        >
          <h2 className="text-xl font-medium sm:text-3xl">
        ...
        <section
          id="infominors"
          className="space-y-4"
          ref={(ref) => setTargetRef('infominors', ref)}
        >
          <h2 className="text-xl font-medium sm:text-3xl">
        ...
        <section
          id="privacyrights"
          className="space-y-4"
          ref={(ref) => setTargetRef('privacyrights', ref)}
        >
          <h2 className="text-xl font-medium sm:text-3xl">
          ...
          <p
            id="withdrawconsent"
            ref={(ref) => setTargetRef('withdrawconsent', ref)}
          >
            <u>
        ...
        <section
          id="caresidents"
          className="space-y-4"
          ref={(ref) => setTargetRef('caresidents', ref)}
        >
          <h2 className="text-xl font-medium sm:text-3xl">
        ...
        <section
          id="policyupdates"
          className="space-y-4"
          ref={(ref) => setTargetRef('policyupdates', ref)}
        >
          <h2 className="text-xl font-medium sm:text-3xl">
        ...
        <section
          id="contact"
          className="space-y-4"
          ref={(ref) => setTargetRef('contact', ref)}
        >
          <h2 className="text-xl font-medium sm:text-3xl">
        ...
        <section
          id="request"
          className="space-y-4"
          ref={(ref) => setTargetRef('request', ref)}
        >
          <h2 className="text-xl font-medium sm:text-3xl">
